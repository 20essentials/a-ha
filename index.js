...
const nameSongs = [
	...
	"TAKE ON ME", /*2*/
	"THE SUN ALWAYS SHINES ON T.V.", /*3*/
	"YOU ARE THE ONE", /*4*/
	"MAYBE MAYBE", /*5*/
	"MANHATTAN SKYLINE ", /*6*/
	"I’VE BEEN LOSING YOU", /*7*/
	"TRAIN OF THOUGHT", /*8*/
	"SUMMER MOVED ON", /*9*/
	"SCOUNDREL DAYS", /*10*/
	"VELVET", /*11*/
	"EARLY MORNING", /*12*/
	"LIVING A BOY’S ADVENTURE TALE", /*13*/
	"HUNTING HIGH AND LOW", /*14*/
	"TOUCHY!", /*15*/
	"CRYING IN THE RAIN", /*16*/
	"THE LIVING DAYLIGHTS", /*17*/
	"I CALL YOUR NAME", /*18*/
	"MINOR EARTH MAJOR SKY", /*19*/
	"WHITE CANVAS", /*20*/
]
